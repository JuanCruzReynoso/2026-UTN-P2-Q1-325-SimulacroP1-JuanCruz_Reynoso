# 💻 Simulacro Examen Parcial I | Programación II

Repositorio oficial para la entrega del **Simulacro Primer Parcial** de la cursada de Programación II (Tecnicatura Universitaria en Programación - UTN FRA).
